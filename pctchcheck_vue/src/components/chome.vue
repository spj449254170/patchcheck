<template>
  <el-container class="home_container">
    <el-header>
      <div class="home_title">金蝶补丁管理平台</div>
      ...
      <el-aside width="200px">
        <el-menu
          ...
          <template v-for="(item,index) in this.$router.options.routes">
            ...
            <template  v-if="!item.hidden && !item.admin" >
              <el-submenu :index="index+''" v-if="true" :key="index">
              <template slot="title">
...
<script>
  ...
  export default{
    ...
    mounted: function () {
      var _this = this;
      getRequest("/user/getuser").then(function (msg) {
        _this.currentUserName = msg.data.data;
